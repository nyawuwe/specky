...
import { showBanner, createSpinner, logError, logInfo, logWarning, showToolsTable, showSpecInfo, showServerReady, showSummary, } from './ui.js';
// Package version
const VERSION = '1.0.0';
// Create CLI program
...
program
    ...
    try {
        ...
        if (options.tags) {
            ...
            filteredEndpoints = filteredEndpoints.filter((ep) => ep.tags.some((tag) => tags.includes(tag.toLowerCase())));
        ...
        // Show spec info
        showSpecInfo(parsedSpec.title, parsedSpec.version, options.baseUrl || parsedSpec.baseUrl);
        // Generate tools
